...
import ChatMessage from '@/components/chatId/ChatMessage.vue';
import { chatAPI } from '@/api/chanId/api';
...
const loadChatHistory = async () => {
  try {
    const history = await chatAPI.getChatHistory('service', UserStore.username);
